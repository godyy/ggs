...
func NewAccountRepository(db *mongo.Database) *AccountRepository {
	return &AccountRepository{
		col: db.Collection(models.MgoCollAccount),
	}
}
...
func (r *AccountRepository) GetAccountByUID(ctx context.Context, uid string) (*models.Account, error) {
...
func (r *AccountRepository) CreateOrGetAccount(ctx context.Context, account *models.Account) (*models.Account, error) {
