...
func NewCharacterRepository(db *mongo.Database) *CharacterRepository {
	return &CharacterRepository{
		col: db.Collection(models.MgoCollCharacter),
	}
}

// createIndexes 创建索引.
func (c *CharacterRepository) createIndexes(ctx context.Context, cli *mongo.Client) error {
	...
	_, err := c.col.Indexes().CreateMany(ctx, indexes)
	return err
}

// CreateCharacter 创建角色
func (c *CharacterRepository) CreateCharacter(ctx context.Context, character *models.Character) error {
	_, err := c.col.InsertOne(ctx, character)
	return err
}

// GetCharacter 根据角色ID获取角色
func (c *CharacterRepository) GetCharacter(ctx context.Context, characterID int64) (*models.Character, error) {
...
func (c *CharacterRepository) GetAllCharactersByAccountID(ctx context.Context, accountID int64) ([]*models.Character, error) {
...
func (c *CharacterRepository) GetCharacterCountByAccountID(ctx context.Context, accountID int64) (int64, error) {
...
func (c *CharacterRepository) GetCharacterCountByAccounIDServerID(ctx context.Context, accountID int64, serverID int64) (int64, error) {
